...
- Manter favoritos, favicon, `apple-touch-icon`, `manifest` e preview social da home ancorados na foto canonica atual (`stack.jpg`), usando crop quadrado centralizado com leve ajuste vertical nos ícones para evitar padding lateral, desequilíbrio no enquadramento ou reaparecimento de imagens antigas ao favoritar/adicionar atalho.
