...
- Manter favoritos, favicon, `apple-touch-icon`, `manifest` e preview social da home ancorados na foto canonica atual (`stack.jpg`), usando crop quadrado centralizado nos ícones para evitar padding lateral ou reaparecimento de imagens antigas ao favoritar/adicionar atalho.
