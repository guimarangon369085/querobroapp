...
function ProductsPageContent() {
  ...
  const handleProductCardKeyDown = (event: KeyboardEvent<HTMLDivElement>, product: Product) => {
    ...
    <BuilderLayoutProvider page="produtos">
      <section className="grid gap-8">
        <BuilderLayoutItemSlot
          id="load_error"
          className={
            isSpotlightSlot('load_error')
              ? 'app-spotlight-slot app-spotlight-slot--active'
              : 'app-spotlight-slot'
          }
        >
          {loadError ? (
        ...
        >
          <form onSubmit={submit} className="app-panel grid gap-5">
            ...
            <div className="app-form-actions app-form-actions--mobile-sticky">
              ...
              {editingId ? (
                <button className="app-button app-button-ghost" type="button" onClick={cancelEdit}>
        ...
        >
          <div className="grid gap-3">
            {loading ? (
              <div className="app-panel border-dashed text-sm text-neutral-500">Carregando produtos...</div>
            ) : (
              <>
